...
public class Ejecucion extends JFrame {
	...
	public Ejecucion() {
		...
		JLabel label_5 = new JLabel("LA - Layout de la p�gina");
		label_5.setFont(new Font("Tahoma", Font.PLAIN, 10));
		label_5.setBounds(52, 81, 232, 14);
		panel_2.add(label_5);
		
		JLabel label_6 = new JLabel("EF - Entendibilidad y facilidad en la interacci�n");
		label_6.setFont(new Font("Tahoma", Font.PLAIN, 10));
		label_6.setBounds(53, 96, 273, 14);
		panel_2.add(label_6);
		
		JLabel label_7 = new JLabel("CR - Control y retroalimentaci�n");
		...
		JLabel label_9 = new JLabel("BU - B�squeda");
				...
				if(navegador.equals("")){
					...
					try {
						...
						if (!Evaluacion.verificarEstado(id_evaluacion)){
							...
							JOptionPane.showMessageDialog(null,"Esta evaluaci�n ya ha sido finalizada, por favor seleccione otra.");
							limpiar();
						}
	...
	public void finalizar(){
		...
		try {
			...
			if(pendientes.next()){
				...
				msjPendiente.mensajeError.setText("<html><div style='margin-top=3px;'><h3 style='color:red'>No se puede finalizar la evaluaci�n debido a que a�n tiene "+(i+-1)+" subcriterios pendientes de calificar: <br></h3>"+criteriosPendientes+"</div></html>");
				msjPendiente.show();
